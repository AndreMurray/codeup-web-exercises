(async () => {
    ...
    //   const picture = card.querySelector("[data-pic]")
    //   const director = card.querySelector("[data-director]")
    //   const buttonCard = card.querySelector("[data-button]")
    //
    //   title.textContent = user.title
    //   date.textContent = user.year
    //   director.textContent = user.director
    //   userCardContainer.append(card)
    //   return { name: user.title, year: user.year, director: user.director, element: card}
    //
    // })
